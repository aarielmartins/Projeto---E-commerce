...
const Checkout = () => {
  ...
  //LIMPA O CARRINHO QUANDO FINALIZA A COMPRA
  useEffect(() => {
    if (isSuccess) {
      dispatch(clear())
    }
  ...
  //DA MAIS SEGURANÇA PRO SITE POIS NÃO PERMITE QUE O USUÁRIO
  //ACESSE A ÁREA DO CHECKOUT SEM QUE EXISTAM ITENS NO CARRINHO
    ...
    <div className="container">
      {isSuccess && data ? (
        <Card title="Muito obrigada">
          <>
            <p>
              É com satisfação que informamos que recebemos seu edido com
              sucesso! <br />
